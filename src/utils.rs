...
mod tests {
    ...
    #[test]
    fn it_works() {
        let var = VarInt::from_mem(&[0b1000_0011, 0b0011_1101, 0b0111_0100]);
        assert!(var.is_ok());
        assert_eq!(var.unwrap().val, 0b000_0011_011_1101);

        let var = VarInt::from_mem(&[0b1000_0001, 0b0011_1001]);
        assert!(var.is_ok());
        assert_eq!(var.unwrap().val, 0b000_0001_011_1001);
        ...
        assert_eq!(
            var.unwrap().val,
            0b000_0001000_0001000_0001000_0001000_0001000_0001
        );
        ...
        assert_eq!(
            var.unwrap().val,
            0b111_1111111_1111111_1111111_1111111_1111111_1111
        );
        ...
        assert_eq!(
            var.unwrap().val,
            0b000_0001000_0001000_0001000_0001000_0001000_0001000_0001
        );
        ...
        assert_eq!(
            var.unwrap().val,
            0b111_1111111_1111111_1111111_1111111_1111111_1111111_1111
        );
        ...
        assert_eq!(
            var.unwrap().val,
            0b000_0001000_0001000_0001000_0001000_0001000_0001000_0001000_0001
        );
        ...
        assert_eq!(
            var.unwrap().val,
            0b111_1111111_1111111_1111111_1111111_1111111_1111111_1111111_1111
        );
        ...
        assert_eq!(
            var.unwrap().val,
            0b000_0001000_0001000_0001000_0001000_0001000_0001000_0001000_0001000_0001
        );
        ...
        assert_eq!(
            var.unwrap().val,
            0b111_1111111_1111111_1111111_1111111_1111111_1111111_1111111_1111111_1111
        );
